...
// class ViewedRecipeCards extends StatelessWidget {
//   final ViewedRecipeHistoryItem recipe;

//   const ViewedRecipeCards({Key? key, required this.recipe}) : super(key: key);
...
//                       ),
//                       TextSpan(
//                         text: recipe.createdDate.toString(),
//                         style: TextStyle(
//                           fontSize: 14,
//                           color: Colors.black,
//                         ),
...
//                     ).addViewedRecipe(recipe.recipeId);
...
//                               title: recipe.title,
//                               url: recipe.url,
//                               // Add other required fields here, using recipe's fields or default values
//                             ),
//                             viewedRecipeId:
